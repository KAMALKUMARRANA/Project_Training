...
```bash
dotnet dev-certs https -v -ep authserver.pfx -p b746c80e-aa92-4279-882c-28b6c915964d
```

> `b746c80e-aa92-4279-882c-28b6c915964d` is the password of the certificate, you can change it to any password you want.
